...
const required = {
  ...
  socios_club: "id numero_excel direccion_tipo zona lote tipo nombre cuota_base estado fecha_creacion importacion_id",
  ...
  importaciones_excel: "id nombre_archivo total_socios total_movimientos",
};
try {
